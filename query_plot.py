...
datasets = ["temporal-reddit-reply"]
...
path = './analysis/'  #  10-10_2_7039154 10-09_9189d8f
...
for measure in measures:
    for dataset in datasets:
        ...
        for k, algo in enumerate(algos):
            ...
            print(algo)
            runtime_file = open(
                path + algo + '_' + dataset + '_' + str(L) + '_runtime.csv',
                'r')
            runerror_file = open(
                path + algo + '_' + dataset + '_' + str(L) + '_runerror.csv',
                'r')
            ...
            if dataset == 'colisten-Spotify':
                ...
                idx = [0, 5]
            plt.plot(runtime[idx[0]:idx[1]],
                     [i[measureIdx[measure]] for i in runerror][idx[0]:idx[1]],
                     label=algo,
                     marker=markers[k],
                     color=colors[k],
                     markersize=25,
        ...
        plt.ylabel(ylabel[measure] + ' - ' + datasets_alias[dataset],
                   fontsize=36)
